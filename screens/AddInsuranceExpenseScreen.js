...
 }, []); 
  ...
  <View style={styles.container}>
    ...
    <Dropdown
      ...
      options={concernedVehicle?.map((e) => {return {label: e.name, value: e._id}})}
    ...
    <View style={styles.addnote}>
      <TextInput style={styles.textnote} placeholder="Ajouter une note à propos de cette dépense ?" keyboardType="text" onChangeText={(value) => setNote(value)} value={note}/>
    </View>        
