          ...
          <View style={{ ...global.mainWrapper, ...styles.bottomWrapper }}>
            <View>
              <SimpleButton
                ...
                callback={(handlePress = () => navigation.navigate("Sign Up"))}
              />
              <Text
                style={{
                  ...global.defaultH6,
              ...
              <SimpleLink
                ...
                txtColor={gColor.mainColor}
                txtHoverColor={gColor.additionalColor}
              />
            </View>
            <View style={styles.contactLinkWrapper}>
              <Simplelinking
                style={styles.contactLink}
                txtStyle={{ ...global.link, ...{ lineHeight: 22 } }}
                txtHoverStyle={{ ...global.linkPressed, ...{ lineHeight: 22 } }}
                icon={<Email fill={gColor.mainColor} width={20} height={20} />}
                iconPress={
                  <Email fill={gColor.additionalColor} width={20} height={20} />
                }
                url="mailto:support@vehicost.com?subject=Contacter le support VehiCost&body=Bonjour le support !  ❤️"
